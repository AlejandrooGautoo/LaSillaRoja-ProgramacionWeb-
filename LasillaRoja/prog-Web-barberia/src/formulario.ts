...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const formulario = document.getElementById('formulario-contacto') as HTMLFormElement;
    ...
    function validarFormulario(datos: DatosFormulario): ErroresValidacion {
    ...
    function mostrarErrores(errores: ErroresValidacion): void {
    ...
    async function enviarDatos(datos: DatosFormulario): Promise<void> {
        try {
